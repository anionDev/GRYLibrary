...
namespace GRYLibrary.Core.GenericWebAPIServer.DefinedMiddlewares.DDOSProtectionMiddleware
{
    ...
    /// </summary>
    public class DDOSProtectionMiddleware :AbstractMiddleware
    {
        private readonly IDDOSProtectionConfiguration _DDOSProtectionSettings;
        /// <inheritdoc/>
        public DDOSProtectionMiddleware(RequestDelegate next, IDDOSProtectionConfiguration ddosProtectionSettings) : base(next)
        {
