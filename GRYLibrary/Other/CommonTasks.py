...
def common_tasks():
    ...
    tf.do_common_tasks(tf.get_version_of_project(),CertificateGeneratorInformationNoGenerate(),False)#codeunit-version should alsways be the same as project-version
