...
def standardized_tasks_run_testcases_for_dotnet_project_in_common_project_structure(self:ScriptCollectionCore, runtestcases_file:str,buildconfiguration:str="Release",commandline_arguments:list[str]=[]):
    ...
    standardized_tasks_build_for_dotnet_executable_project_in_common_project_structure(ScriptCollectionCore(),repository_folder, codeunit_name, buildconfiguration, True,output_folder,commandline_arguments)
