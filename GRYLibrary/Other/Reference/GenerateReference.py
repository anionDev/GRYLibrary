...
def standardized_tasks_generate_refefrence_for_dotnet_project_in_common_project_structure(self: ScriptCollectionCore, repository: str):
    reference_folder = os.path.join(repository, "GRYLibrary", "Other", "Reference")
...
def generate_reference():
    standardized_tasks_generate_refefrence_for_dotnet_project_in_common_project_structure(
        ScriptCollectionCore(), str(Path(os.path.dirname(__file__)).parent.parent.parent.parent.absolute()))
